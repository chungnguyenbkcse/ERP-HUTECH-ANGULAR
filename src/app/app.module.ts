 ...
 * declarations: Nó là một mảng của các Component được tạo ra.
 * imports: Nó là một mảng các module cần thiết để được sử dụng trong ứng dụng.
 * provides: Khai báo một mảng các service sẽ được sử dụng trong ứng dụng tại đây. 
 * bootstrap: Khai báo main component của ứng tại đây.
 */
@NgModule({
